...
public class UpgradeTooltip : MonoBehaviour
{
    ...
    public void ShowTooltip(string name, List<CostData> costs, int currentLevel, int maxLevel, UnityEngine.Vector3 uiPosition, float buttonHeight, Transform tr, long baseStatValue)
    {
    ...
    private void UpdateTooltipPosition()
    {
        ...
        UnityEngine.Vector3 currentUIPos = targetTransform.position;
        ...
        UnityEngine.Vector2 targetScreenPos = RectTransformUtility.WorldToScreenPoint(canvasCam, currentUIPos);
        ...
        if (expectedTopScreenY > Screen.height)
        {
            ...
            UnityEngine.Vector3 downPos = currentUIPos + (UnityEngine.Vector3.down * downOffset);
            downPos.z = 0f;
        ...
        else
        {
            ...
            UnityEngine.Vector3 targetPos = currentUIPos + (UnityEngine.Vector3.up * upOffset);
            targetPos.z = 0f;
